...
**/
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        intent.putExtra(Intent.EXTRA_TEXT,"Hey check out this cool weather app - https://drive.google.com/file/d/0B26hT4Og3tBOekpuZ2IwWFlNVFk/view?usp=sharing");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId)
        {
            ...
            case R.id.action_share:
                return true;
            default:mDrawerToggle.onOptionsItemSelected(item);
    ...
    protected void showAbout() {
        ...
        builder.setIcon(R.mipmap.weather_icon);
    ...
    public void speak()
    {
        String text=CurrentFragment.getToSpeak();
